...
Revision ID: 1ef13f9f2458
Revises: 
Create Date: 2023-07-28 11:37:53.076346
...
def upgrade():
    ...
    sa.Column('releaseSet', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['releaseSet'], ['ReleaseSets.id'], name=op.f('fk_Cards_releaseSet_ReleaseSets')),
    sa.PrimaryKeyConstraint('id')
    )
